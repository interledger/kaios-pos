...
export async function sendPaymentToPosService(
  ...
  const endpoint = "https://5f87cc0f2b55.ngrok-free.app/payment";

  try {
    console.log("=== SENDING PAYMENT TO POS SERVICE ===");
    ...
    if (!signSecret) {
      console.warn(
        "sendPaymentToPosService called without signSecret; request will not be signed",
      );
    }
    ...
    console.log("=== POS SERVICE RESPONSE ===");
    ...
    console.error("=== POS SERVICE REQUEST ERROR ===");
